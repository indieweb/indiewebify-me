...
<?php elseif (isset($bloggingSoftware) and $bloggingSoftware === 'mediawiki'): ?>
	<p>It looks like you’re using MediaWiki to power your site — check out the IndieWebCamp <a href="http://indiewebcamp.com/MediaWiki">MediaWiki wiki page</a> for tips on how to indiewebify your MediaWiki site!</p>
