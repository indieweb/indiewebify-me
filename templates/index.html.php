...
<?php echo $render('validate-rel-me.html', $render) ?>

<?php echo $render('validate-h-card.html', $render) ?>

<?php echo $render('validate-h-entry.html', $render) ?>

<?php echo $render('send-webmentions.html', $render) ?>
